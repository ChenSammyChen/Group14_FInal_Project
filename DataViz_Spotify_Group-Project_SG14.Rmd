---
title: "Analysis 1 - Our own music tastes"
...
# Introduction
Music is so present in everyone's life but have you ever thought about the data behind the music that you listen to every day? Let's have a look at the music on Spotify, one of the biggest music streaming service. We are going to analyze the audio features, content, time, location, and much more.

## Spotify API set-up
The tool that we use to retrieve the data is Spotify API for developers.It allows us to retrieve JSON metadata about music artists, albums, and tracks, directly from the Spotify Data Catalogue.
The instructions we refered to for setting up Spotify API are [here](https://r-music.rbind.io/posts/2018-10-01-rspotify/)!
