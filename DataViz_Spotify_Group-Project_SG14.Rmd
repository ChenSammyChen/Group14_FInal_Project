...
- Energy: measure of a track’s intensity and activity; high energy is typically loud and noisy
...
No we know that Filippo seems to like all of his songs to have the same tempo. Ruchen, Filippo and Marie seem to enjoy rather unknown songs as well!
...
Let's check today's most popular songs from Spotify and usethe audio features mentioned above to find out why today’s top hits are the most popular and if there are any differences in what a song sounds like depending on the artist's genre

```{r top 100 dimension distribution}
# wanted to explore gender dynamics for artist; playlist is retrieved from API but we manually imputed gender dynamics onto playlist
...
Seems like popular music is all about the danceability and energy of a track. Today's popular songs seem to not be played live or involve many instruments. It is also interesting to see that songs from female artists seem to overall be happier (higher valence) and more acoustic.

> But this is only what makes today’s music popular. Let’s see which factors are most important in determining popularity overall!
