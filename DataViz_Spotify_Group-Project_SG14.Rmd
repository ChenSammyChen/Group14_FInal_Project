...
First, we try to understand the content behind a song. For that, we use text mining on Spotify's Top 50 World playlist to understand what are the most frequently appeared words.
